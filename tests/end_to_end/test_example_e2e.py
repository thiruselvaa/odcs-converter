...
class TestCompleteWorkflows:
    ...
    def test_compliance_review_workflow(self, temp_dir, scenario_test_helper):
        ...
        success, results, errors = scenario_test_helper.simulate_compliance_review_workflow(temp_dir)
    ...
    def test_large_contract_processing(self, temp_dir, production_like_odcs):
        ...
        assert excel_path.stat().st_size > 50000  # Should be reasonably large file
...
class TestCLIWorkflows:
    ...
    @cli_test
    def test_cli_odcs_to_excel_conversion(self, temp_dir, cli_test_helper, complete_odcs_data):
        ...
        # Run CLI conversion
        success, stdout, stderr = cli_test_helper.test_odcs_to_excel_cli(input_json, output_excel)
    ...
    @cli_test
    def test_cli_excel_to_odcs_conversion(self, temp_dir, cli_test_helper, complete_odcs_data):
    ...
    @cli_test
    def test_cli_roundtrip_conversion(self, temp_dir, cli_test_helper, complete_odcs_data):
        ...
        success1, _, stderr1 = cli_test_helper.test_odcs_to_excel_cli(original_json, intermediate_excel)
...
class TestPerformanceWorkflows:
    ...
    @performance_test
    def test_conversion_performance_benchmarks(self, temp_dir, performance_test_helper, complete_odcs_data):
        ...
        assert medium_times["odcs_to_excel"] < 15.0, "Medium dataset conversion too slow"
    ...
    @performance_test
    def test_memory_usage_during_conversion(self, temp_dir, performance_test_helper, complete_odcs_data):
...
class TestErrorHandlingWorkflows:
    ...
    def test_file_system_error_scenarios(self, temp_dir, error_scenario_test_helper):
        ...
        for expected_error in expected_errors:
            assert expected_error in errors_handled, f"Missing error handling: {expected_error}"
    ...
    def test_data_corruption_scenarios(self, temp_dir, error_scenario_test_helper):
        ...
        scenarios_tested = error_scenario_test_helper.test_data_corruption_scenarios(temp_dir)
    ...
    def test_invalid_cli_usage(self, cli_test_helper):
        ...
        assert not success  # Should fail gracefully
        assert "usage" in stderr.lower() or "help" in stderr.lower()  # Should show usage info
