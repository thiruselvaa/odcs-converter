...
class DataQuality(BaseModel):
    ...
    dimension: Optional[QualityDimensionEnum] = Field(None, description="Quality dimension")
...
class SchemaProperty(BaseModel):
    ...
    logicalType: Optional[LogicalTypeEnum] = Field(None, description="Logical data type")
    ...
    partitionKeyPosition: Optional[int] = Field(-1, description="Partition key position")
...
class SchemaObject(BaseModel):
    ...
    businessName: Optional[str] = Field(None, description="Business name")
    dataGranularityDescription: Optional[str] = Field(None, description="Data granularity")
    properties: Optional[List[SchemaProperty]] = Field(None, description="Object properties")
...
class ServiceLevelAgreementProperty(BaseModel):
    ...
    value: Union[str, int, float, bool, None] = Field(..., description="Agreement value")
...
class ODCSDataContract(BaseModel):
    ...
    slaProperties: Optional[List[ServiceLevelAgreementProperty]] = Field(None, description="SLA properties")
    authoritativeDefinitions: Optional[List[AuthoritativeDefinition]] = Field(None, description="Authoritative definitions")
    customProperties: Optional[List[CustomProperty]] = Field(None, description="Custom properties")
    contractCreatedTs: Optional[datetime] = Field(None, description="Contract creation timestamp")
