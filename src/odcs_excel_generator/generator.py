...
class ODCSExcelGenerator:
    ...
    def generate_from_file(self, input_path: Union[str, Path], output_path: Union[str, Path]) -> None:
    ...
    def generate_from_dict(self, data: Dict[str, Any], output_path: Union[str, Path]) -> None:
    ...
    def _create_workbook(self, data: Dict[str, Any], contract: Optional[ODCSDataContract]) -> Workbook:
        ...
        self._create_authoritative_definitions_sheet(workbook, data.get('authoritativeDefinitions', []))
        self._create_custom_properties_sheet(workbook, data.get('customProperties', []))
        
        return workbook
    
    def _create_basic_info_sheet(self, workbook: Workbook, data: Dict[str, Any]) -> None:
    ...
    def _create_description_sheet(self, workbook: Workbook, description: Dict[str, Any]) -> None:
    ...
    def _create_servers_sheet(self, workbook: Workbook, servers: List[Dict[str, Any]]) -> None:
        ...
        # Add headers
        headers = ['Server', 'Type', 'Description', 'Environment', 'Location', 'Host', 'Port', 'Database']
        for col, header in enumerate(headers, 1):
            cell = sheet.cell(row=1, column=col, value=header)
            self._apply_header_style(cell)
    ...
    def _create_schema_sheet(self, workbook: Workbook, schema: List[Dict[str, Any]]) -> None:
        ...
        # Add headers
        headers = ['Object Name', 'Physical Name', 'Logical Type', 'Physical Type', 'Description', 'Business Name']
        for col, header in enumerate(headers, 1):
            cell = sheet.cell(row=1, column=col, value=header)
            self._apply_header_style(cell)
    ...
    def _create_support_sheet(self, workbook: Workbook, support: List[Dict[str, Any]]) -> None:
    ...
    def _create_pricing_sheet(self, workbook: Workbook, pricing: Dict[str, Any]) -> None:
    ...
    def _create_team_sheet(self, workbook: Workbook, team: List[Dict[str, Any]]) -> None:
    ...
    def _create_roles_sheet(self, workbook: Workbook, roles: List[Dict[str, Any]]) -> None:
        ...
        # Add headers
        headers = ['Role', 'Description', 'Access', 'First Level Approvers', 'Second Level Approvers']
        for col, header in enumerate(headers, 1):
            cell = sheet.cell(row=1, column=col, value=header)
            self._apply_header_style(cell)
    ...
    def _create_sla_properties_sheet(self, workbook: Workbook, sla_properties: List[Dict[str, Any]]) -> None:
    ...
    def _create_authoritative_definitions_sheet(self, workbook: Workbook, definitions: List[Dict[str, Any]]) -> None:
    ...
    def _create_custom_properties_sheet(self, workbook: Workbook, custom_properties: List[Dict[str, Any]]) -> None:
